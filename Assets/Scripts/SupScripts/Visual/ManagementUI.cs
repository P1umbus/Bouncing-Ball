...
{
    [SerializeField] private Image[] ExtraElements;
    [SerializeField] private Text[] ExtraElementsText;
    ...
    {
        foreach (Image GO in ExtraElements)
        {
            GO.color = new Color(GO.color.r, GO.color.g, GO.color.b, 0);
        }
        foreach (Text GO in ExtraElementsText)
        {
            GO.color = new Color(GO.color.r, GO.color.g, GO.color.b, 0);
        }
    }
